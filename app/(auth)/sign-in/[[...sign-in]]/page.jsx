                    ...
                    <div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-white/80 text-lg max-w-md leading-relaxed">Sign in to access your account and create engaging popups that convert visitors into customers.</p>
                            </div>
