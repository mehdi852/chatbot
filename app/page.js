                        ...
                        {[
                            {
                                ...
                                preview: (
                                    <div className="space-y-3 w-full">
                                        <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg p-3 border border-primary/20 w-full">
                                        ...
                                        <div className="bg-gradient-to-r from-secondary/10 to-secondary/5 rounded-lg p-3 border border-secondary/20 w-full">
                                            <div className="flex items-center justify-between w-full">
                            ...
                            },
                            {
                                ...
                                preview: (
                                    <div className="space-y-3 w-full">
                                        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 border-l-4 border-blue-500 w-full">
                                            <div className="text-xs font-medium text-blue-700 dark:text-blue-300">💬 Chat Widget</div>
                                            <div className="text-xs text-blue-600 dark:text-blue-400">Live support conversations</div>
                                        </div>
                                        <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-3 border-l-4 border-green-500 w-full">
                                            <div className="text-xs font-medium text-green-700 dark:text-green-300">📧 Email Capture</div>
                                            <div className="text-xs text-green-600 dark:text-green-400">Lead generation forms</div>
                                        </div>
                                        <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-3 border-l-4 border-purple-500 w-full">
                                            <div className="text-xs font-medium text-purple-700 dark:text-purple-300">🎯 Exit Intent</div>
                                            <div className="text-xs text-purple-600 dark:text-purple-400">Smart trigger popups</div>
                                        </div>
                                    </div>
                                )
                            },
                            {
                                ...
                                preview: (
                                    <div className="space-y-3 w-full">
                                        ...
                                        <div className="bg-gradient-to-r from-orange-500/10 to-orange-500/5 rounded-lg p-3 border border-orange-500/20 w-full">
                                            <div className="flex items-center space-x-2 mb-2">
                            ...
                            <motion.div
                                ...
                                <div className="bg-card border border-border rounded-lg p-6 hover:shadow-md transition-all duration-300 h-full flex flex-col">
                                    {/* Header */}
                                    ...
                                    {/* Interactive Preview */}
                                    <div className="relative mt-4 flex-grow flex flex-col">
                                        <div className="bg-muted/30 rounded-md p-3 border border-border/50 flex-grow flex flex-col">
